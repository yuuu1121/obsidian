...
1. WSL에서 Docker container를 실행하면 Docker desktop 왼쪽의 Container 탭과 VScode의 Docker extension에서 확인 가능
   ![[Attachments/General/Pasted image 20240731154625.png]]
   ![[Attachments/General/Pasted image 20240731154643.png|+grid]]![[Attachments/General/Pasted image 20240731154847.png|+grid]]
2. Dev containers extension 설치
   ...
   - 해당 Container 혹은 Ubuntu를 Connect 하면 VScode에서 터미널로 사용 가능
	![[Attachments/General/Pasted image 20240731155359.png]]
