...
related notes:
  - "[[2_Resource/1_Study/3_ML/Clustering/Clustering Algorithms]]"
  - "[[2_Resource/1_Study/3_ML/Clustering/Clustering]]"
---
# Euclidean Clustering
- 가장 간단한 군집화 방법으로, 두 점 사이의 거리를 계산 해서 특정 거리 이하일 경우 동일한 군집으로 간주하는 방법
- 군집의 개수가 정해지지 않은 [[2_Resource/1_Study/3_ML/Clustering/Clustering Algorithms#계층적 군집 (Hierarchical Clustering)|계층적 군집]]이며, 거리를 계산하는 거리 척도로 [[2_Resource/1_Study/3_ML/Clustering/Distance#유클리디안 거리 (Euclidean Distance)|유클리디안 거리 (Euclidean Distance)]]를 사용
## 동작 과정
1. 효율적인 계산을 위하여 포인트 클라우드의 [[2_Resource/1_Study/3_ML/Clustering/KDTree]] 구조체 생성
