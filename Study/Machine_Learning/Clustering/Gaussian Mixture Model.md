...
- **Definition**
	- 각 하위 분포가 [[Various Distributions#Gaussian Distribution (Normal Distribution)|Gaussian Distribution]]을 따르는 Mixture Model의 일종
...
## Learning GNN
- **Objective**
	- GMM의 모델 파라미터 $\theta = \{\pi_k, (\mu_k, \sigma_k)\}_{k \in [K]}$의 [[Maximum Likelihood Estimation]] 수행
