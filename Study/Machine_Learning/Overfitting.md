...
- 과적합은 매개변수의 수가 많아지거나 (모델의 복잡도가 높을 때) 매개변수의 크기가 지나치게 커질 경우 발생
	...
	- 과적합을 방지하기 위해선 [[Bayesian Inference|Bayesian Approach]]과 같이 사전 정보를 반영하거나, [[Study/Machine_Learning/Regularization|Regularization]] 처럼 학습 시 패널티를 추가하여 모델의 복잡도를 제어
