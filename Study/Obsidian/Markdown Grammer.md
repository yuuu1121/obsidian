...
- [[#General Markdown Grammer|General Markdown Grammer]]
	- [[#General Markdown Grammer#Headers|Headers]]
	- [[#General Markdown Grammer#Bold|Bold]]
	- [[#General Markdown Grammer#Italic|Italic]]
	- [[#General Markdown Grammer#Strikethrough|Strikethrough]]
	- [[#General Markdown Grammer#List|List]]
		- [[#List#순서가 있는 리스트|순서가 있는 리스트]]
		- [[#List#순서가 없는 리스트|순서가 없는 리스트]]
	- [[#General Markdown Grammer#Link|Link]]
	- [[#General Markdown Grammer#Image|Image]]
	- [[#General Markdown Grammer#Blockquotes|Blockquotes]]
	- [[#General Markdown Grammer#Code|Code]]
	- [[#General Markdown Grammer#Horizontal Rule|Horizontal Rule]]
	- [[#General Markdown Grammer#Footnotes|Footnotes]]
		- [[#Footnotes#기본 각주 문법|기본 각주 문법]]
		- [[#Footnotes#여러 줄의 각주 작성|여러 줄의 각주 작성]]
		- [[#Footnotes#이름이 지정된 각주|이름이 지정된 각주]]
		- [[#Footnotes#문장 안 각주 넣기|문장 안 각주 넣기]]
	- [[#General Markdown Grammer#Table|Table]]
- [[#For Obsidian Only|For Obsidian Only]]
	- [[#For Obsidian Only#Highlight|Highlight]]
	- [[#For Obsidian Only#Check Box|Check Box]]
	- [[#For Obsidian Only#Image Size|Image Size]]
	- [[#For Obsidian Only#Internal Link|Internal Link]]
	- [[#For Obsidian Only#Embedding Link|Embedding Link]]
	- [[#For Obsidian Only#Block Reference|Block Reference]]
	- [[#For Obsidian Only#Callout|Callout]]
		- [[#Callout#Callout 지원리스트|Callout 지원리스트]]
- [[#Meta Data|Meta Data]]
	- [[#Meta Data#Frontmatter|Frontmatter]]
		- [[#Frontmatter#옵시디언 프론트매터 생성방법|옵시디언 프론트매터 생성방법]]
	- [[#Meta Data#프론트매터 기본요소 (Tags, Aliases)|프론트매터 기본요소 (Tags, Aliases)]]
		- [[#프론트매터 기본요소 (Tags, Aliases)#Tags|Tags]]
			- [[#Tags#Tags 입력 방법|Tags 입력 방법]]
			- [[#Tags#Tag 작성 규칙|Tag 작성 규칙]]
		- [[#프론트매터 기본요소 (Tags, Aliases)#Aliases|Aliases]]
			- [[#Aliases#Aliases 입력 방법|Aliases 입력 방법]]
			- [[#Aliases#Aliases 활용하기|Aliases 활용하기]]
	- [[#Meta Data#Inline field|Inline field]]
		- [[#Inline field#옵시디언 인라인필드 생성방법|옵시디언 인라인필드 생성방법]]
- [[#Reference|Reference]]
...
- 결과
	![[Attachments/General/58a89a5e3696dee4406bd962fe1e4f00_MD5.png|500]]
...
- 결과
	![[Attachments/General/dac9a2b90b974498b4bfc94f4cc275c1_MD5.png|500]]
...
- 결과
	![[Attachments/General/41cf37cb267389e82227fe005c3ee977_MD5.png|500]]
...
- 결과
	![[Attachments/General/db5b1c1f453dc49920775ff7fb0b1f08_MD5.png|500]]
...
- 결과
	![[Attachments/General/bf5e62e37e8dae902f31965ba581c3c6_MD5.png|150]]
...
- 결과
	![[Attachments/General/c9c79ca93e1aa1d7f3b8c21e6823c060_MD5.png|500]]

## Block Reference
블록 참조는 다른 블록 내용을 현재 블록에 포함시키는 기능입니다. `![[블록 링크#^id]]` 형식으로 사용합니다.
ID를 부여한 문단 만 임베딩 되며, 사용자가 ID를 직접 부여하기 위해선 문단 끝에 `^myobsi` 형식으로 사용합니다.
![[Attachments/General/94a907200b4fad9504e5223ed1ffa931_MD5.png|500]]
```text
![[옵시디언 사용법#^myobsi]]
```

- 결과
	![[Attachments/General/4985d563e85f2ecd8601698b393af502_MD5.png|500]]
...
#### Aliases 활용하기
- 가장 좋은 방법은 내부링크(`[[]]`)를 걸어주거나 백링크(back link)를 걸어줄 때
