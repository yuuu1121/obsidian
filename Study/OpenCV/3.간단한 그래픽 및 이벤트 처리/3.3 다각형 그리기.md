...
```
![[Attachments/e8086ed346a6046fd6ace79d691d8c17_MD5.jpeg|300]]
...
cv2.destroyAllWindows()
```
![[Attachments/c594135fa39446fa3a2bc8fca44bc9df_MD5.jpeg|300]]
...
cv2.destroyAllWindows()
```
![[Attachments/c8f4d3fcfcececb3fd9b9a393f491608_MD5.jpeg|300]]
...
cv2.destroyAllWindows()
```
![[Attachments/70fa5cc34d37497bfbd9394f94ddd2fb_MD5.jpeg|300]]
...
- cv2.fillPoly(img, [pts1, pts2], color=(0, 0, 255)) : 한번에 2개의 다각형 채움.
		![[Attachments/521e581a790c30752d0be5ddfe464587_MD5.jpeg|300]]