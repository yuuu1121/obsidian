...
| ![[Attachments/General/e2aacbe7a99cd90628d46baf120d965d_MD5.jpeg\|400]] | ![[Attachments/General/dc7bccf1ff1e7a3983195cc5a890f7a1_MD5.jpeg\|400]] |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| N = 4                                                                       | N = 32                                                                      |
- src.shape : 
...
cv2.destroyAllWindows()
```
![[Attachments/General/d45f7b2bf70274213c360dcf90fece47_MD5.jpeg]]
- roi[0] : 열(x) 
- roi[1] : 행(y)
- roi[2] : 가로 크기(width)
- roi[3] : 세로 크기(height)
...
rects = [[239 166 142 166]
 ...
 [246 124 138 152]]
```
![[Attachments/General/0748cbdfd3aa3eccfdf9b950fd5400fb_MD5.jpeg|300]]
- rects = cv2.selectROIs('src', src, False, True) :
