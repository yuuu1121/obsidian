...
<class 'numpy.ndarray'>
```
![[Attachments/dccfb14cb057a603d4e6ec6a8d36753c_MD5.jpeg]]
...
cv2.destroyAllWindows()
```
![[Attachments/6671a4a9d58413a8b12b303ef6f29c70_MD5.jpeg|300]]
- cv2.merge[r,g,b]는 cv2.merge([b, g, r])과 다른 색상의 컬러를 생성.
	- BGR 순서였던 이미지가 RGB 순서로 바뀌지만, OpenCV는 여전히 BGR로 해석하기 때문에 색상이 달라짐.
	- ![[Attachments/458613a0f33ce34ea1d25d5668f32352_MD5.jpeg|300]]