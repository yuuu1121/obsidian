...
![[Attachments/7bc79c053eed84ad10878ed86ca2903e_MD5.jpeg]]
...
```
![[Attachments/a20b974b6962fa92ac43d8828e4bddda_MD5.jpeg|500]]
...
cv2.destroyAllWindows()
```
![[Attachments/b7ae07ae8da822bfd442bd5ffa72879a_MD5.jpeg|500]]
- #2 : 
	- 이미지에서 특정 밝기 이상의 픽셀을 선택하여 이진화(Thresholding)하고, 반전 마스크를 생성.
	- ret, dst = cv2.threshold(src, thresh, maxval, type) :
		- ![[Attachments/63d81a0759eb83408dde31ad611cabb5_MD5.jpeg|600]]
...
n =  0
```
![[Attachments/8fc5e48bb0ec7e6af60a2aa0644e69e8_MD5.jpeg|600]]
