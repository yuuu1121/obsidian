...
```
![[Attachments/General/675d7fc5af9bc617825ced02843f61f4_MD5.jpeg|300]]
- minVal, maxVal, minLoc, maxLoc = cv2.minMaxLoc(src) :
...
cv2.destroyAllWindows()
```
![[Attachments/General/b699ef3ca0efab724c82e2e59d961f45_MD5.jpeg|300]]
- pts = np.zeros((1, nPoints, 2), dtype=np.uint16) :
...
cv2.destroyAllWindows()
```
![[Attachments/General/afd5dd3b37fde28d0bc4900e38de2360_MD5.jpeg|300]]
- cv2.randn(pts, mean=(256, 256), stddev=(50, 50)):
...
```
- ![[Attachments/General/48b9f23cf9367cd1b100163d74b1f6b8_MD5.jpeg|200]]
- cov, mean = cv2.calcCovarMatrix(X, mean=None, flags = cv2.COVAR_NORMAL + cv2.COVAR_ROWS) :
...
cv2.destroyAllWindows()
```
![[Attachments/General/b21144b4669ddb2ee37d73df9f7906fa_MD5.jpeg|300]]
...
Y.shape= (512, 512, 3)
```
![[Attachments/General/19e9c70b917d3009e96f82a7c5b6a6f3_MD5.jpeg]]
