...
plt.show()
```
![[Attachments/584871439664d9019328ef45d01ab666_MD5.jpeg|300]]
![[Attachments/08ed7bf79e24a229bf31fcedea60a875_MD5.jpeg|400]]
- hist2 = cv2.calcHist(images=[dst], channels=[0], mask=None, histSize=[256], ranges=[0, 256]) : 
...
cv2.destroyAllWindows()
```
![[Attachments/058121576f766e1d11849046ae90faba_MD5.jpeg|600]]
