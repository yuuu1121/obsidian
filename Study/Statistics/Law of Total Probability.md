...
- **Law of total probability**:
	...
	- [[주변 확률(marginal probability)]](e.g., $P(A)$)을 조건부 확률을 통해 구하는 과정으로, 특정 정보나 변수를 고려하지 않고 전체 확률을 구할 수 있게 해줌
- **Marginalization**:
	- ==관심 있는 사건$A$에 대한 [[주변 확률(marginal probability)|주변 확률(marginal probability)]] $P(A)$를 구하는 과정==
...
![[3_Archive/3_Drawing/drawing240503.excalidraw]]
